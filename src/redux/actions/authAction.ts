...
export const loadUserDetailsApi =
  ...
  async (
    dispatch: (arg0: {
      payload: User | undefined;
      type:
        | "auth/loadUserDetailsStart"
        | "auth/loadUserDetailsSuccess"
        | "auth/loadUserDetailsFail";
    }) => void
  ) => {
    try {
      const { data } = await axiosInstance.get("/me");
...
export const loadAllUserApi =
  ...
  async (
    dispatch: (arg0: {
      ...
      type:
        | "auth/loadAllUserStart"
        | "auth/loadAllUserSuccess"
        | "auth/loadAllUserFail";
    }) => void
  ) => {
    try {
...
export const loadSingleUserApi =
  ...
  async (
    dispatch: (arg0: {
      payload: User | undefined;
      type:
        | "auth/loadSingleUserStart"
        | "auth/loadSingleUserSuccess"
        | "auth/loadSingleUserFail";
    }) => void
  ) => {
    try {
...
export const followUnFollowUserApi =
  ...
  async (
    dispatch: (arg0: {
      type:
        | "auth/followUnfollowUserStart"
        | "auth/followUnfollowUserSuccess"
        | "auth/followUnfollowUserFail";
    }) => void
  ) => {
    try {
